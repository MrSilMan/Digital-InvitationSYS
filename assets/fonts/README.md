...
| `cormorant-sc-latin(-ext)-500-normal` | Cormorant SC Medium | Praia Rosa |
| `cormorant-sc-latin(-ext)-700-normal` | Cormorant SC Bold   | Praia Rosa |
...
All four fonts are licensed under the SIL Open Font License 1.1 (`OFL-*.txt`), which allows
