      ...
      },
      {
        ...
        test: {
          ...
          env: {
            ...
            // MinIO from docker-compose (CI starts one), with a bucket of its own.
            S3_ENDPOINT: process.env.TEST_S3_ENDPOINT ?? 'http://localhost:9000',
            S3_REGION: 'us-east-1',
            S3_BUCKET: 'convites-media-test',
            S3_ACCESS_KEY_ID: 'convites',
            S3_SECRET_ACCESS_KEY: 'convites-dev-secret',
